...
class DND_Commands(commands.Cog):
    """
    List of commands for handling DND related tasks, e.g. creating characters or getting item descriptions
    """
    ...
    async def describe(self, ctx, *, object: str):
        ...
        reply = await self.get_openai_response("You explain objects from a magical and mysterious world.", msg)
        await ctx.send(reply)
